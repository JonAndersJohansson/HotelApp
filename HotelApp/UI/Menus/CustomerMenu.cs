...
namespace HotelApp.UI.Menus
{
    ...
    public class CustomerMenu : IMenu
    {
        ...
        {
        "1. Visa alla kunder", "2. Lägg till en ny kund", "3. Uppdatera kundinformation på befintlig kund", "4. Ta bort en kund (om inga bokningar finns kopplade)"
        };
        ...
        {
            switch (_displayList.BrowseAList(listCustomerMenu, false, "╔═════════════════════════════════════════╗\n║                 KUNDER                  ║\n╚═════════════════════════════════════════╝", true))
            {
                case 0:
                    //Visa alla kunder
                    break;
